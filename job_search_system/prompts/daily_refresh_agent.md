...
8. After writing the file and generating resumes, reload `job_search_system/job_board.html`; the board will auto-import new jobs, update resume and apply links, and de-duplicate old ones.
```
